...
def data_muokkaus(taulukko):
    try:
        ...
        taulukko["pesälle"] = taulukko["aputilasto"]
        taulukko["pesälle"] = taulukko["pesälle"].str.split("}").str[1].str.strip()
        taulukko["pesälle"] = taulukko["pesälle"].apply(lambda x: str(x).strip(", '"))
        taulukko["pesälle"] = taulukko["pesälle"].str.lstrip("nan")
